...
import fsoft.xdev.mock.dao.imp.SupportingMaterialDao;
import fsoft.xdev.mock.models.SupportingMaterial;

public class SupportingMaterialDaoTest{
	
	@Mock
	private ISupportingMaterialDao mockingSupportingMaterialDao;

	@Before
	public void setUp() throws Exception {
		mockingSupportingMaterialDao = mock(SupportingMaterialDao.class);
	}

	@After
	public void tearDown() throws Exception {
		mockingSupportingMaterialDao = null;
	}

	@Test
	public void testAdd_ExpectionTrue() {
		SupportingMaterial supportingMaterial = new SupportingMaterial();
		mockingSupportingMaterialDao.add(supportingMaterial);
		verify(mockingSupportingMaterialDao).add(supportingMaterial);
	}

	@Test
	public void testEdit_ExpectionTrue() {
		SupportingMaterial supportingMaterial = new SupportingMaterial();
		mockingSupportingMaterialDao.edit(supportingMaterial);
		verify(mockingSupportingMaterialDao).edit(supportingMaterial);
	}
	...
	public void testFindRange_All_Active_ExpectionNotEmptyList() {
		...
		mockingSupportingMaterialDao.findRange(from, to, filterKey, filterActive);
		verify(mockingSupportingMaterialDao).findRange(from, to, filterKey, filterActive);
	}
	...
	public void testCount_All_InActive_ExpectionNotZeroItems() {
		String filterKey = "All";
		boolean filterActive = false;
		mockingSupportingMaterialDao.count(filterKey, filterActive);
		verify(mockingSupportingMaterialDao).count(filterKey, filterActive);
	}
