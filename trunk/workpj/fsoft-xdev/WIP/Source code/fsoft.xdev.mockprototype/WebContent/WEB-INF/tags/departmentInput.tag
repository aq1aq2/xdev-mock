...
<div class="xdev-window" >
	...
	<div class="xdev-window-body">
		<div class="xdev-window-body-sub" id="details">
			...
			<s:form>
				<s:textfield name="departmentName" label="Department Name" required="true"></s:textfield>
				<s:textarea name="departmentShortDesc" label="Department Short Description" cols="12" rows="3" required="true"></s:textarea>
				<s:textfield name="leadContact" label="Lead Contact" readonly="true"></s:textfield>
				<s:label value="Lookup"></s:label>
				<s:radio name="copyAddressFrom" label="Copy Address From" list="{'Organisation', 'Parent'}"></s:radio>
				...
				<s:textarea name="departmentFullDescription" label="Department Full Description" cols="12" rows="3"></s:textarea>
